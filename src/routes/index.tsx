...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Student Helper — Ton prof IA pour réussir le BAC" },
      { name: "description", content: "Coach IA personnalisé pour les bacheliers Sciences Maths au Maroc. Explications en français, arabe et darija. Exercices, simulations BAC, suivi de progression." },
      { property: "og:title", content: "Student Helper — Ton prof IA pour réussir le BAC" },
      { property: "og:description", content: "Coach IA personnalisé pour les bacheliers Sciences Maths au Maroc." },
    ],
  }),
  component: Landing,
});
